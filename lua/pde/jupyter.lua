...
local function repl_menu()
  ...
  local hint = [[
 ^
 _e_: Execute Cell             _s_: Send Motion
 _i_: Insert Cell              _l_: Send Line
 _j_: Next Cell                _t_: Send Until Cursor
 _k_: Previous Cell            _f_: Send File
 ...
 _H_: Hide
  ...
  return {
    ...
    heads = {
      ...
      { "i", insert_cell_before, desc = "Insert Cell", },
