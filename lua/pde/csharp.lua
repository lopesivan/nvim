...
return {
  ...
  -- Mason
  {
    ...
    opts = function(_, opts)
      -- vim.list_extend(opts.ensure_installed, { "netcoredbg", "csharp-language-server", "omnisharp", "csharpier", "omnisharp-mono" })
      vim.list_extend(opts.ensure_installed, { "netcoredbg", "omnisharp", "csharpier" })
    end,
  },
  -- null
  {
